...
namespace UC_2_Find_Frequency_in_Paragraph
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Write("\n");
            Console.WriteLine("Sequence of paragraph phrase are: ");
            Console.WriteLine("-----------------------------------------");
            Console.WriteLine("\"" + hash0 + " " + hash1 + " " + hash2 + " " + hash3 + " " + hash4 + "\n " + hash5 + " " + hash6 + " " + hash7 + " " + hash8 + " " + hash9 + " " + hash10 + " " + hash11 + "\n "+ hash12 + " " + hash13 + " " + hash14 + " " + hash15 + " " + hash16 + " " + hash17 + " " + hash18 + "\"");
            Console.WriteLine("\n");
        }
    }
}
